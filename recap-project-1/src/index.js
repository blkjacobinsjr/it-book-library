...
async function renderBooks() {
    ...
    const publisherSelect = document.querySelector("#by-publisher");
    const tbody = document.querySelector("tbody");
    const favCount = document.querySelector(".mainnav-number");
        ...
        filtered.forEach((book) => {
            ...
            heartBtn.addEventListener("click", () => {
                ...
                if (favs.includes(book.isbn)) {
                    favs = favs.filter((id) => id !== book.isbn);
                }
                else {
                    favs.push(book.isbn);
                }
    ...
    publisherSelect.addEventListener("change", () => {
        ...
        if (selected === "-") {
            ...
            const filtered = books.filter((book) => book.publisher.toLowerCase() === selected.toLowerCase());
            render(filtered);
        }
    });
}
